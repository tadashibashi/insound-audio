...
class EmPointer
{
     ...
     */
    malloc(bytes: number, mod: EmscriptenModule): void
    {
        if (bytes <= 0)
            throw Error("Cannot allocate 0 bytes");
...
/**
 * A class for handling multiple buffers
 */
export
class EmBufferGroup
{
    ...
    /**
     * Summation of the byte size of all buffers
     */
